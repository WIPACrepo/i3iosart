...
\item Filtered data files containing events selected by the online filter
  ...
  \textcolor{red}{center} in the Northern Hemisphere by the data handling system.
...
\textcolor{red}{Two copies of each archival data stream are saved, and the disks are
