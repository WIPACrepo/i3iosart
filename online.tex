...
immediately written to new archival media with a single command.  Two
copies of each archival data stream are saved, and the disks are
transported from the South Pole to a Northern Hemisphere data center each
year.  Archival data are not regularly reprocessed but are retained
indefinitely in case of an issue with the filtered data streams.
