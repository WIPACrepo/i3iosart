...
\item GCD Dispatch, a database caching system to prevent the
  ...
  geometry, calibration and detector status (CGD) information.  
...
Data streams intenteded to satellite transfer are queued separately.  
...
failsafes have been implemented, allowing average detector uptimes of greater
