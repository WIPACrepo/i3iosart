...
\unit[399]nm and spectral width \unit[14]nm (FHWM), including a
...
of 48$^{\circ}$, which is close to the Cherenkov angle in ice ($n=1.317$). 
...
a profile proportional to $1+\cos{\alpha}$ where $\alpha$ is the LED axis.
...
The current amplitude is controlled by the
