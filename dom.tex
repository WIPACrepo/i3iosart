...
The PMT detects signals from neutrino events typically ranging over energies
...
1000 DOMs produced (PSL, DESY, Stockholm) and tested (PSL, DESY and
Uppsala University, Sweden). Finally, Stage 3 involved procurements,
