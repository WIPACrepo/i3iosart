...
The LED current waveforms are recorded in an auxiliary ATWD channel, which
establishes the onset of optical pulses \unit[8]{nsec} after the current pulse rising edge.
