...
self-calibration.  Self-calibration functions establish PMT and preamplifier
...
digital saturation.  The mean preamplifier gains of all deployed DOMs for high-,
...
interval of \unit[6.4]$\mu$s after the launch. Its preamplifier provides a
...
\begin{figure}[h]
 ...
 \caption{Example digitized waveforms in the ATWD (top) and the fADC (bottom):
