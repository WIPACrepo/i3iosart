...
the DOM glass.  The wires are routed inside a customized cable, shown in figure~\ref{fig:domcable},
...
The standard Flasher Board, shown in figure~\ref{fig:flasherdiagram}, is
...
deployment harnesses were attached (figure~\ref{fig:domcable}) and the DOMs individually packed. 
