...
% Include table of non-standard operation?
% Non-standard operation (total)
% dead ATWD
% bad Local Coincidence

We can estimate the surviving fraction of DOMs 20 years after the original
...
surviving fraction in 2025 to be $97.7\pm0.2\%$.  While this model does not
account for an increase in failure rate due to component aging, the
observed failure rate since detector completion of $2.0~\mathrm{yr}^{-1}$ is
significantly 
lower than the mean predicted rate of $4.5~\mathrm{yr}^{-1}$.  We attribute
...
\begin{figure}[!h]
 ...
 \caption{Predicted fraction of surviving DOMs in 2025 versus time, based on an assumed
 constant post-freeze-in failure rate.  Statistics improve during
 construction as more DOMs are deployed.}
