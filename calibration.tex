...
physical units (Sec.~\ref{sec:waveformcal}).  Global time calibration /
synchronization across the array of DOMs is 
...
ICL clock domain at the midpoint, without prior knowledge of cable
...
shown in Figure~\ref{fig:charge_fadcshift}.  To avoid this issues, whenever the
...
tracked throughout the year. The threshold, defined here as the point which
...
\cite{Ahrens:2003fg}; charge and time information from the DOM under study excluded
