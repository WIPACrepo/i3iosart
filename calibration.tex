...
baselines for numerical charge integration during the calibration procedure.
...
Each histogram is fit with an exponential plus Gaussian model
(Fig.~\ref{fig:domcal_hvfit}).  The peak of the Gaussian component is used
to 
...
of the 20MHz clocks of the DOM and surface electronics (DOR, Sect.~\ref{sect:online:master_clock}).  In order to improve the precision
...
of the PMT high voltage, Main Board channel preamplifiers, and the digitizers.
...
front-end electronic preamplifiers and the digitizers themselves.  The
stability is demonstrated by comparing the Main Board channel preamplifier gains
from sets of calibrations taken from 2011 to 2016
(Fig.~\ref{fig:domcal_ch_gain}).  From year to year, the preamplifier gain 
...
\begin{figure}[!h]
  ...
  \caption{Fractional ATWD channel preamplifier gain shifts, from 2015 to
