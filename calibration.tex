...
single waveform contains approximately at least 12 PE (at least 0.06 PE in the
...
\begin{table}[h!]
\caption{Characteristics of noise components in IceCube DOMs, adapted from Ref.~\cite{stanisha_noise_14}.}
  \centering
  \footnotesize
