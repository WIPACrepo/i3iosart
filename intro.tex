...
idenfitication and characterization of their sources.  Other diverse science
...
is required due to the small cross-section of neutrinos with ordinary matter. The glacial
...
and embedded processor hosted on the mainboard. The digitized data are sent to a
...
events. The average \textit{deposited} energy resolution for both event types
...
are not instrumented, as it is a region in the ice of significantly
