...
is described in section~\ref{sec:dom_calibration}. The digitized data are sent to a
...
covered in section~\ref{sec:drill-deploy}. An overview of the data flow as well as
...
in cosmic rays \cite{IC3:moon,IC3:sun}.  Muons with energies above the
minimum-ionizing regime, typically $\SI{1}{\tera\electronvolt}$ in ice,
undergo energy losses dominated by stochastic processes.  This results in
large fluctuations in the amount of energy deposited 
