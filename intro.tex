...
built into the glacial ice at the South Pole. Construction was completed
...
IceCube, DeepCore, and IceTop --- using the same DOM design and associated surface readout. A schematic layout of the Observatory is
...
\begin{figure}[!h]
 ...
 \caption{The IceCube Neutrino Observatory with the IceCube Array, its sub-array DeepCore and
   the cosmic-ray air shower array IceTop. The different
   string/station colors
...
array is deployed. A denser in-fill array is formed by the eight
