...
cables  (figure~\ref{fig:icecube-cables-logical}). The in-ice cable, $\SI{2505}{\meter}$ long, is deployed
...
cables vary from 300~m to approximately 800~m in length depending on hole location. The surface cables are
...
terminate at the DOMHub, the computer that receives DOM signals in the ICL
(section~\ref{sect:sps}). Each 
...
\end{table}
 ...
 of 40~kN. During deployment, the maximum tension on the cable was less
...
cable (figure~\ref{fig:cable_xsection}). The surface cable has a similar
...
to produce the raw cable, and SEACON Brantner \& Associates (El Cajon,
...
potential (high voltage) testing. 
...
up the hole in its reaming phase (section~\ref{sec:hot_water_drilling}).  After the drill was removed,
the end of the in-ice cable was pulled into the drill tower, and DOM deployment
commenced (section~\ref{sec:deployment_inst}). After DOM
