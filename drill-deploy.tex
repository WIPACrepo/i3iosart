...
positional data from an inclinometer installed on the drill show that the string is not perfectly vertical,
...
\begin{figure}[!ht]
  \captionsetup[subfigure]{labelformat=empty} \centering
  \subfloat[]{\includegraphics[width=0.4\textwidth]{graphics/geometry/Trilat_full.pdf}}
  \subfloat[]{\includegraphics[width=0.6\textwidth]{graphics/geometry/newtrilat85.pdf}}
  \caption{Left: example of the trilateration procedure. Right: distance vs. relative depth as measured by flashers for
    two strings that were deployed at nearly the same depth with no
    anomalies during deployment. Right: the same plot for a different pair;
    in this case, the pressure sensor on the flashing string failed during
    deployment.}
