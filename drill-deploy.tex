...
outside the drill tower. The hole diameter was logged before deployment using a
...
\begin{figure}[!ht]
  \captionsetup[subfigure]{labelformat=empty} \centering
  \subfloat[]{\includegraphics[width=0.48\textwidth]{graphics/geometry/trilat_circles.pdf}}
  \subfloat[]{\includegraphics[width=0.48\textwidth]{graphics/geometry/newtrilat85.pdf}}
