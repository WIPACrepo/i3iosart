...
ranger. All depths were converted to $z$-coordinates in the IceCube
coordinate system.
...
The Stage 2 geometry assumes that all strings are vertical. However, data from the drill shows that the string is not perfectly vertical,
