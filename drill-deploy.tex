...
\begin{minipage}{\textwidth}
  ...
  \begin{tabular}{ l | r }
    \bf{Specification} & Value \\ \hline Total Power (Thermal + Electrical)
...
\begin{minipage}{\textwidth}
  \centering \captionof{table}{Average and peak performance for a 24-hour
    lifetime hole of 2500 m depth. (Peak taken from IceCube hole 32)}
  \begin{tabular}{ l | r  | r }
    \bf{Specification} & Avg. Value & Peak Value\\ \hline Total
    Fuel\footnote{Total Fuel includes deep drilling/reaming and firn
...
Hot water drilling was not practical in the firn layer, the surface layer of
...
Due to the massive size and complexity of the SES, it remained stationary
...
reciprocal calibration. In general, the upgoing log will be more reliable,
...
\subsubsection{Trilateration Validation of DOM Coordinates}
...
$\sim$\numrange[range-phrase = --]{0.01}{0.02}\unitfrac[]{degrees}{year}
...
The Sweden Camera system was deployed on String 80 in the final
...
housed in separate glass pressure spheres \SI{5.8}{meter} apart, between the
bottom DOM and the string weights at a depth of \SI{2455}{meter}.  Each
